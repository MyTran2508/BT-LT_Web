...
public class Download_Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        String url = "/Ex7.2/index.jsp";
        if (action.equals("viewAlbums")) {
            url = "/Ex7.2/index.jsp";
        } else if (action.equals("checkUser")) {
            url = checkUser(request, response);
        } else if (action.equals("viewCookies")) {
            url = "/Ex7.2/view_cookies.jsp";
    ...
    private String checkUser(HttpServletRequest request,
        ...
        if (user == null) {
            ...
            // if cookie exists, create User object and go to Downloads page
                ...
                url = "/Ex7.2/" + productCode + "_download.jsp";
            }
        } 
    ...
    private String registerUser(HttpServletRequest request,
        ...
        String url = "/Ex7.2/" + product.getCode() + "_download.jsp";
        return url;
   }
    ...
    private String deleteCookies(HttpServletRequest request,
        ...
        String url = "/Ex7.2/delete_cookies.jsp";
        return url;
    }
}